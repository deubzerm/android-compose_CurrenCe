...
@Singleton
class ApplicationExchangeRatesDataSource @Inject constructor() : ExchangeOperations {

    private val exchangeDictionary =
        mutableMapOf<Pair<CurrencyEnum, CurrencyEnum>, Float>(
